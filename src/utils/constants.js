...
export const API_OPTIONS = {
  method: "GET", //specifying the HTTP method to use(method property)
  headers: {
    accept: "application/json",
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlNWZmYTRjN2JkN2JjOWZkZGI5NThlNDgxYjA3YmEyZCIsInN1YiI6IjY1ZmFmNjkxYTE5OWE2MDEzMGRkNzkzYSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.mF85pKzN-9vPpn4IVrmq3XS3r5WrdAafskbxfZBMBsA",
  },
};
...
export const SUPPORTED_LANG = [//array of supported languages
  { identifier: "en", name: "English" },
  { identifier: "sans", name: "Sanskrit" },
